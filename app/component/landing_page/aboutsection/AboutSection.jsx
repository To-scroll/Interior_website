...
import aboutimg from '../../../../public/images/interior1.webp'
    ...
    return (
        <div className='relative w-full px-6 lg:px-12 xl:px-44 lg:mt-32 mb-10'>
            <div className='flex flex-col  lg:flex-row w-full lg:items-center justify-between'>
                <h3 className='text-[40px] lg:text-[85px] font-medium leading-10 lg:leading-24'>About<span className='inline-block'><RxSlash className='text-[#d0d0cf]' /></span><br /> Haven Builders</h3>
            ...
            <div className='flex flex-col lg:flex-row mt-10'>
                ...
                <div className='flex-1 mt-10 lg:mt-0 lg:pl-24 pr-10'>
                    <h3 className='text-[#636363] text-[20px] lg:text-[26px] font-medium tracking-wide text-left'>
                        Haven Builders is a team of experienced architects and interior designers
                    </h3>
