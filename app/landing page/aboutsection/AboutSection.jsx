...
const AboutSection = () => {
    return (
        <div className='relative w-full px-6 xl:px-44 lg:mt-32 mb-10'>
            ...
            <div className='flex flex-col lg:flex-row mt-10'>
                ...
                <div className='flex-1 mt-10 lg:mt-0 lg:pl-24 pr-10'>
                    <h3 className='text-[#636363] text-[20px] lg:text-[26px] tracking-wide text-left'>
                        Archipix is a team of experienced architects and interior designers
                    </h3>
                    <p className='mt-7 lg:mt-10 text-[#7f7f7f] leading-7 tracking-wide text-justify text-[16px]'>
